...
osgEarth::CDBTile::CDBElevationService  CDBElevationService_Instance;
...
std::string osgEarth::CDBTile::CDB_Tile::Get_RootDir(void)
{
	return m_cdbRootDir;
}

std::string osgEarth::CDBTile::CDB_Tile::Get_CacheDir(void)
{
	return m_cdbCacheDir;
}

CDB_Tile_Type osgEarth::CDBTile::CDB_Tile::Get_TileType(void)
{
	return m_TileType;
}
...
bool osgEarth::CDBTile::CDB_Tile::Contains(coord2d LLPoint)
{
...
bool osgEarth::CDBTile::OGR_File::Set_Layer_Fields(osgEarth::Feature * f, OGRLayer * poLayer)
{
	...
	{
		std::pair<std::string, osgEarth::AttributeValue> temp;
		temp = *ti;
		std::string name = temp.first;
		osgEarth::AttributeValue value = temp.second;
		osgEarth::AttributeType attrType = value.first;
...
osgEarth::CDBTile::ElevationProviderTile::ElevationProviderTile(osgEarth::CDBTile::ElevationProviderTile* Parent, 
							std::string cdbRootDir, std::string cdbCacheDir, CDB_Tile_Type TileType,
...
osgEarth::CDBTile::ElevationProviderTile::~ElevationProviderTile()
{
	if (Have_Children())
	{
...
bool osgEarth::CDBTile::ElevationProviderTile::GeneratePyramid()
{
	if (GenerateChildren())
	{
		if (m_LogService)
...
bool osgEarth::CDBTile::ElevationProviderTile::GenerateChildren()
{
...
osgEarth::CDBTile::ElevationProviderTile* osgEarth::CDBTile::ElevationProviderTile::New_Child(CDB_Tile_Extent* Extent)
{
...
osgEarth::CDBTile::CDB_Tile* osgEarth::CDBTile::ElevationProviderTile::Get_Tile()
{
	return m_ElevationTile;
}

bool osgEarth::CDBTile::ElevationProviderTile::Tile_Exists(void)
{
	return m_ElevationTile->Tile_Exists();
}

bool osgEarth::CDBTile::ElevationProviderTile::Contains(coord2d LLPoint)
{
	return m_ElevationTile->Contains(LLPoint);
}

osgEarth::CDBTile::ElevationProviderTile* osgEarth::CDBTile::ElevationProviderTile::GetEndChildContaining(coord2d LLPoint)
{
...
bool osgEarth::CDBTile::ElevationProviderTile::Get_Elevation(osgEarth::CDBTile::CDBElevationService* Service, coord2d LLPoint, float& elevation)
{
...
void osgEarth::CDBTile::ElevationProviderTile::Add_Child(osgEarth::CDBTile::ElevationProviderTile* child)
{
...
bool osgEarth::CDBTile::ElevationProviderTile::Have_Children()
{
...
osgEarth::CDBTile::CDBElevationService::CDBElevationService()
{
...
void osgEarth::CDBTile::CDBElevationService::ClearResources()
{
...
bool osgEarth::CDBTile::CDBElevationService::StartElevationService(std::string cdbRootDir, std::string cdbCacheDir, bool DataFromGlobal)
{
...
bool osgEarth::CDBTile::CDBElevationService::InitElevationTile(CDB_Tile_Extent* tile_extent)
{
	if (!m_have_init_data)
		return false;
...
bool osgEarth::CDBTile::CDBElevationService::Get_Elevation(coord2d Point, float& elevation)
{
...
bool osgEarth::CDBTile::CDBElevationService::RegisterServiceTile(std::string FileName, ElevationProviderTile* Tile)
{
...
osgEarth::CDBTile::CDBElevationService* osgEarth::CDBTile::CDBElevationService::getInstance(void)
{
